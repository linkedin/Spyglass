...
public interface Suggestible {
    ...
    // Main text for the given suggestion, as will be shown to the user. Note other data fields can be added (other text,
    // pictures), but this is the only required field, as it is used for the default layout.
